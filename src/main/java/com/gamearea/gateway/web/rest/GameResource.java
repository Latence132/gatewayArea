...
/**
 * REST controller for managing {@link com.gamearea.gateway.domain.Game}.
 */
@RestController
@RequestMapping("/api")
public class GameResource {
     ...
     */
    @GetMapping("/games")
    public ResponseEntity<List<Game>> getAllGames(Pageable pageable, @RequestParam(required = false, defaultValue = "false") boolean eagerload) {
