...
describe('Game e2e test', () => {
  ...
  it('should load Games', async () => {
    ...
    expect(await gameComponentsPage.getTitle()).to.eq('gatewayApp.game.home.title');
  ...
  it('should load create Game page', async () => {
    ...
    expect(await gameUpdatePage.getPageTitle()).to.eq('gatewayApp.game.home.createOrEditLabel');
  ...
  it('should create and save Games', async () => {
    ...
    await promise.all([
      gameUpdatePage.stateSelectLastOption(),
      gameUpdatePage.cardGroupSelectLastOption(),
  ...
  it('should delete last Game', async () => {
    ...
    expect(await gameDeleteDialog.getDialogTitle()).to.eq('gatewayApp.game.delete.question');
