...
import { CardGroupComponent } from 'app/entities/card-group/card-group.component';
...
describe('Component Tests', () => {
  describe('CardGroup Management Component', () => {
    let comp: CardGroupComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(CardGroupComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.cardGroups && comp.cardGroups[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
